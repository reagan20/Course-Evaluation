        ...
        <div class="col-md-12">
            <div class="panel panel-color panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title">Administrator Accounts:</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="table-responsive">
                                ...
                                INNER JOIN roles
                                    ON (lecturers.role_id = roles.role_id)WHERE lecturers.role_id=1";
                                    ...
                                    while($row=mysqli_fetch_assoc($qry)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-xs btn-info" data-target="#staff_details<?php echo $count; ?>" data-toggle="modal"><i class="fa fa-pencil"></i> Edit</a>
                                                <a class="btn btn-xs btn-danger" name="delete" onclick="return confirm('Sure to delete? It will be deleted permanently!')"
                                                   href="?action=transview&id=<?php echo $row['pf_number']?>&act=delete"><i class="fa fa-remove"></i> Remove</a>
                                            </td>
