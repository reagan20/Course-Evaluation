    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-color panel-primary">
                <div class="panel-heading">Add New Course <i class="fa fa-plus-square"></i></div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <select class="form-control" name="school" id="school">
                                ...
                                <?php
                                $s=$conn->query("SELECT * FROM schools");
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                while($row=mysqli_fetch_assoc($qry)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-xs btn-info" data-target="#course<?php echo $count;?>" data-toggle="modal" data-backdrop="false"><i class="fa fa-pencil"></i>  Edit</a>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content" style="">
                                                ...
                                                <div class="modal-body">
                                                    <form method="post" action="edit_course.php?id=<?php echo $row['course_code']?>">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="form-group">
