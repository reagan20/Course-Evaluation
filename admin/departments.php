        ...
        <div class="row">
            ...
            <div class="panel panel-color panel-primary">
                ...
                <div class="panel-body">
                    ...
                    INNER JOIN evaluation.schools ON (departments.school_id = schools.school_id)";
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <table id="datatable" class="table table-striped table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-info" data-target="#edit_dept<?php echo $row['dept_id']?>" data-toggle="modal"><i class="fa fa-pencil"></i> Edit</a>
                                        <a class="btn btn-xs btn-danger" name="delete" onclick="return confirm('Sure to delete? It will be deleted permanently!')"
                                           href="?action=transview&id=<?php echo $row['dept_id']?>&act=delete"><i class="fa fa-remove"></i> Remove</a>
                                    </td>
