    ...
    <div class="row">
        <div class="col-md-12">
            <div class="well well-lg">
                <h3>Welcome back, you are logged in as Dean.</h3>
                <p>The following are the operations that you will be able to perform as a dean.<br/>
                <ol>
                    <li>A dean is able to add a new department in his/her school.</li>
                    <li>Adding a new programme.</li>
                    <li>Adding new course.</li>
                    <li>Creating lecturer accounts.</li>
                    <li>Monitoring allocation of courses by the lecturers.</li>
