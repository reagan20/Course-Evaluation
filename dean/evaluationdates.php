                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text"name="year" placeholder="2017/2018">
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                ...
                                FROM
                                    ...
                                    while($row=mysqli_fetch_assoc($qry)){
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-info" data-target="#set_date<?php echo $row['evaluation_id']?>" data-toggle="modal" data-backdrop="static"><i class="fa fa-pencil"></i></button>
                                                <a class="btn btn-sm btn-danger" name="delete" onclick="return confirm('Sure to delete? It will be deleted permanently!')"
                                                   href="?action=transview&id=<?php echo $row['evaluation_id']?>&act=delete"><i class="fa fa-remove"></i></a>
                                            </td>
...
<script src="../admin/assets/bootstrap-datepicker/bootstrap-datepicker.min.js"></script>
