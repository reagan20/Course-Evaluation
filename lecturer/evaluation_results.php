    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="page-title">
                <h4 class="title">Evaluation Results.</h4>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <form method="post">
                        <div class="row">
                            <div class="col-md-7">
                                <select id="filter_course" onchange="getResult(this)" class="form-control" data-live-search style="height: 50px; text-align: center;" name="filter_course">
